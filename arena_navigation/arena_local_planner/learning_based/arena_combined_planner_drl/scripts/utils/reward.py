...
class RewardCalculator:
    ...
    def _cal_reward_rule_05(
        ...
        **kwargs
        ...
        self._reward_following_global_plan(kwargs["global_plan"], kwargs["robot_pose"], action=kwargs["action"], dist_to_path=0.5, reward_factor=0.1)
        self._reward_distance_global_plan(kwargs["global_plan"], kwargs["robot_pose"], reward_factor=0.2, penalty_factor=0.0)
