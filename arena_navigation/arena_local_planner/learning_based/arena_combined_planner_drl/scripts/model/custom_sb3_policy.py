...
# just for knowing that this type exists for printing all available types, 
# even though the way of using it is simply setting params in sb3 only
AgentFactory.register_no_cb("CUSTOM_MLP")
